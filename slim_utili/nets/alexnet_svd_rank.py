...
def alexnet_v2(inputs,
  ...
  with tf.variable_scope(scope, 'alexnet_v2', [inputs]) as sc:
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected, slim.max_pool2d],
      ...
      net = slim.conv2d(net, 384, [3, 1], scope='conv3_h')

      K = K_dict['alexnet_v2/conv4']
      net = slim.conv2d(net, K, [1, 3], scope='conv4_v', activation_fn=None)
      net = slim.conv2d(net, 384, [3, 1], scope='conv4_h')

      K = K_dict['alexnet_v2/conv5']
      net = slim.conv2d(net, K, [1, 3], scope='conv5_v', activation_fn=None)
      net = slim.conv2d(net, 256, [3, 1], scope='conv5_h')
      ...
      with slim.arg_scope([slim.conv2d],
        ...
        net = slim.conv2d(net, K, [1, 5], scope='fc6_v', padding='VALID', activation_fn=None)
        net = slim.conv2d(net, 4096, [5, 1], scope='fc6_h', padding='VALID')
